...
topGround = createSprite(200,50,800,20);
...
function spawnObstaclesTop() 
{
  if(World.frameCount % 60 === 0) {
    obstacleTop = createSprite(width,200,40,50);
...
{
      if(World.frameCount % 60 === 0) {
        obstacleBottom = createSprite(width,height-100 ,40,50);
